...
use futures_core::{FusedStream, ready, Stream};
use pin_project_lite::pin_project;

pin_project! {
    #[derive(Debug)]
    #[must_use = "streams do nothing unless polled"]
    pub struct ChainAfterwards<St1, St2> {
        #[pin]
        first: Option<St1>,
        #[pin]
        second: St2,
...
impl<St1, St2> ChainAfterwards<St1, St2>
    where
        St1: Stream,
...
impl<St1, St2> FusedStream for ChainAfterwards<St1, St2>
    where
        St1: Stream,
...
impl<St1, St2> Stream for ChainAfterwards<St1, St2>
    where
        St1: Stream,
        St2: Stream<Item = St1::Item>,
{
