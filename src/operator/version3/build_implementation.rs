...
#[async_trait]
impl BuildVersion for Version3 {
    type Map = ReadonlyPartitionedConcurrentSelfHashJoinMap;
    ...
    ) -> Result<(ReadonlyPartitionedConcurrentSelfHashJoinMap, RecordBatch), DataFusionError> {
