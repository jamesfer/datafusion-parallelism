...
impl LeftOuterProbeLookupStream {
    ...
    pub fn streaming_probe_lookup<Lookup>(
        ...
        Ok(left_outer_join_streaming_lookup(
            join_schema,
            probe_stream,
            probe_expressions,
            build_expressions,
...
fn left_outer_join_streaming_lookup<Lookup>(
    ...
    probe_stream
        .map(move |result_probe_batch| {
            lookup_left_outer_join_probe_batch(
                &output_schema_clone,
                &probe_expressions,
                &build_expressions,
                &filter,
...
fn lookup_left_outer_join_probe_batch<Lookup>(
    output_schema: &SchemaRef,
    probe_expressions: &Vec<PhysicalExprRef>,
    build_expressions: &Vec<PhysicalExprRef>,
    filter: &Option<JoinFilter>,
