...
use crate::shared::datafusion_private::{append_right_indices, apply_join_filter_to_indices, equal_rows_arr, get_anti_indices};
...
impl RightOuterProbeLookupStream {
    ...
    pub fn streaming_probe_lookup<Lookup>(
        ...
        Ok(right_outer_join_streaming_lookup(
            join_schema,
            probe_stream,
            probe_expressions,
            build_expressions,
