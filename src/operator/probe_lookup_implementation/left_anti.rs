...
impl LeftAntiProbeLookupStream {
    ...
    pub fn streaming_probe_lookup<Lookup>(
        ...
        Ok(Box::pin(left_anti_join_streaming_lookup(
            join_schema,
            probe_stream,
            probe_expressions,
            build_expressions,
...
fn left_anti_join_streaming_lookup<Lookup>(
    ...
    probe_stream
        .flat_map(move |result_probe_batch| {
            match result_probe_batch.and_then(|result_probe_batch| lookup_left_anti_join_probe_batch(
                &output_schema,
                &probe_expressions,
                &build_expressions,
...
fn lookup_left_anti_join_probe_batch<Lookup>(
    output_schema: &SchemaRef,
    probe_expressions: &Vec<PhysicalExprRef>,
    build_expressions: &Vec<PhysicalExprRef>,
    build_side_records: &RecordBatch,
